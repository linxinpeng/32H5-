    ...
    <div class="personal">
        ...
        <div class="content">
            <van-cell-group :border="true">
                <van-field clearable label="姓名" input-align="right" v-model="user.name" placeholder="请输入姓名" />
                <van-field clearable label="身份证" input-align="right" v-model="user.IDCard" placeholder="请输入身份证号" />
                <van-field clearable label="联系电话" input-align="right" type="tel" v-model="user.phone" placeholder="请输入投保人手机号码" />
