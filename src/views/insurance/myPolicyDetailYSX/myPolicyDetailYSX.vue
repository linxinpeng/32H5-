    ...
    <div class="my-policy-detail">
        ...
        <div class="box">
            <div class="b1">
                ...
                <div class="b1-r">
                    <img src="../../../assets/image/insurance/ysx.png" />
                </div>
            </div>
            <div class="box1">
                <div class="content">
                    <div class="current">
                        ...
                        <van-row>
                            ...
                            <van-col style="color: #666666;" span="16">陈翻翻</van-col>
                        </van-row>
                        <van-row>
                            <van-col span="8">身份证号</van-col>
                            <van-col style="color: #666666;"  span="16">350628********5555</van-col>
                        </van-row>
                        <van-row>
                            <van-col span="8">车牌号</van-col>
                            <van-col style="color: #666666;"  span="16">闽DEF345</van-col>
                        </van-row>
                        <!-- <hr /> -->
                    </div>
                    <div class="info">
